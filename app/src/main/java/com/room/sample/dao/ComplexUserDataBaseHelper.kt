...
object ComplexUserDataBaseHelper {
    private val databseName: String = "complexuserdatabase"
    private var dataBase: ComplexUserDataBase? = null
       private get() {
           return field
       }
       private set
    ...
    @JvmStatic
    fun getDb(app:Application):ComplexUserDataBase{
        if (dataBase == null) {
